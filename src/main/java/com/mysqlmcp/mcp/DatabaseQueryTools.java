...
public class DatabaseQueryTools {
    ...
    public String executeSelect(
        ...
        apiKeyAuthService.validateApiKeyAndPermission(apiKey, com.mysqlmcp.enums.DatabasePermission.SELECT);
    ...
    public String explainQuery(
        ...
        apiKeyAuthService.validateApiKeyAndPermission(apiKey, com.mysqlmcp.enums.DatabasePermission.EXPLAIN);
